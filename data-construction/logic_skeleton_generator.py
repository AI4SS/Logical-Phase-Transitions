...
if __name__ == "__main__":
    ...
    # default arguments
    # seed default=730,when generating extra data,we tend to use 1989 as the seed
    ...
    parser.add_argument("--rule_as_goal_proportion", type=str, default="[0.80, 0.20]", help="The first number represents the proportion of logic skeletons with a fact conclusion, while the second indicates those with a rule conclusion.")
    parser.add_argument("--fact_num_threshold", type=int, default=9, help="when the size of the fact pool exceeds the threshold, there will be a possibility that the fact will be directly given")
    parser.add_argument("--fact_num_prob", type=float, default=0.2)
