# ProofWriter with Direct (Ollama Version) - No reasoning
import argparse
import json
import time
import re
...
def main():
    ...
    if args.output_file:
        ...
        logfilename = f'results/proofwriter/results-proofwriter-direct-ollama--{model_name}--t{args.temperature}--{dataset_name}--k_{args.majoritycnt}--{time.strftime("%Y-%m-%d-%H-%M-%S", t)}.jsonl'
