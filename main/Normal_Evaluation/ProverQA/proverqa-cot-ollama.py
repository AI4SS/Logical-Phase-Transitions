# ProverQA with Chain-of-Thought (Ollama Version)
import argparse
import json
import time
import re
...
Your output should be in json format with two keys:reasoning and answer.
...
def main():
    ...
    if args.output_file:
        ...
        logfilename = f'results/proverqa/results-proverqa-cot-ollama--{model_name}--t{args.temperature}--{dataset_name}--k_{args.majoritycnt}--{time.strftime("%Y-%m-%d-%H-%M-%S", t)}.jsonl'
